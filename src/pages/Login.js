      ...
      <div className="flex flex-col lg:flex-row h-full">
        ...
        >
          ...
          <div>
            ...
            <p className="text-white/70 text-sm md:text-base leading-7 mt-6 max-w-md">
          ...
          <div className="w-full max-w-xl">
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-orange-500 flex items-center justify-center text-white text-xl md:text-2xl shadow-lg">
            ...
            <p className="text-[10px] md:text-xs text-white/40 mt-8 text-center">
